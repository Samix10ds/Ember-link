  ...
  return (
    <div>
      ...
      <div className="bg-surface p-4 rounded-xl border border-line mb-6 text-sm text-zinc-400 space-y-2">
        ...
        <p>Il bot sta connesso 24/7 a Discord. Quando cambi gioco/canzone, il bot lo scrive su Supabase e il tuo profilo si aggiorna in tempo reale senza ricaricare la pagina.</p>
